...
},beforePageText:"页数",afterPageText:"到 {pages}",displayMsg:"数据从  {from} 到  {to} 页   总条数: {total}",nav:{first:{iconCls:"pagination-first",handler:function(){
